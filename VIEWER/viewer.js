...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Upload functionality removed for viewer role; upload inputs were removed from the UI.

  // initialize filters (empty dataset OK)
  initializeFilters();

  /* ========== ADMIN GUIDE MODAL ========== */
  // Admin/User guide removed for viewer role; link and modal were removed from the UI.

  // Developer documentation removed for viewer role; developer modal and link were removed from the UI.
...
/* -----------------------------
   Sample download removed for viewer role (button removed in UI)
   ----------------------------- */
